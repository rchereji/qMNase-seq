...
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k1_boxplot_DHS.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'O_boxplot_DHS.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k2_boxplot_DHS.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k1_boxplot_5_states.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'O_boxplot_5_states.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k2_boxplot_5_states.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k1_boxplot_promoter_3_tertiles.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'O_boxplot_promoter_3_tertiles.S2_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k2_boxplot_promoter_3_tertiles.S2_exp1.eps'));

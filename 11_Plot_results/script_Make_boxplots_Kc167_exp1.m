...
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k1_boxplot_DHS.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'O_boxplot_DHS.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k2_boxplot_DHS.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k1_boxplot_5_states.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'O_boxplot_5_states.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k2_boxplot_5_states.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k1_boxplot_promoter_3_tertiles.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'O_boxplot_promoter_3_tertiles.Kc167_exp1.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'k2_boxplot_promoter_3_tertiles.Kc167_exp1.eps'));

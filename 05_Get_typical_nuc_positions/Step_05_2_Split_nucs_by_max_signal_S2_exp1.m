...
load(fullfile(pathName, 'NucCounts.100-200.S2_exp1.mat'), 'Chr', 'Loc', 'NucCount')
...
title('S2_exp1', 'interpreter', 'none')

set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', ...
    fullfile(pathName, 'Percentage_of_color-coded_nucs.S2_exp1.eps'));
...
fileID = fopen(fullfile(pathName, 'Color_coded_nucs.S2_exp1.bed'), 'W');

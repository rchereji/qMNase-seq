...
load('../../data/S2_exp2/local_norm_factor.S2_exp2.mat', 'bad_region_Filter', 'local_norm_factor')
...
% Align profiles
load('../../data/S2_exp2/Spikein_normalized_profiles.100-200.S2_exp2_seq1_1min.dm6.mat', 'Occ_147');
...
load('../../data/S2_exp2/Spikein_normalized_profiles.100-200.S2_exp2_seq1_2min.dm6.mat', 'Occ_147');
Norm_occ = cellfun(@(x,y) x./y, Occ_147, local_norm_factor, 'un', 0);
AlignedProfile = align_sites(Norm_occ, myChr, myLoc, beforeSite, afterSite);
Avg_counts_02 = nanmean(AlignedProfile);

load('../../data/S2_exp2/Spikein_normalized_profiles.100-200.S2_exp2_seq1_5min.dm6.mat', 'Occ_147');
Norm_occ = cellfun(@(x,y) x./y, Occ_147, local_norm_factor, 'un', 0);
AlignedProfile = align_sites(Norm_occ, myChr, myLoc, beforeSite, afterSite);
Avg_counts_05 = nanmean(AlignedProfile);

load('../../data/S2_exp2/Spikein_normalized_profiles.100-200.S2_exp2_seq1_15min.dm6.mat', 'Occ_147');
Norm_occ = cellfun(@(x,y) x./y, Occ_147, local_norm_factor, 'un', 0);
AlignedProfile = align_sites(Norm_occ, myChr, myLoc, beforeSite, afterSite);
Avg_counts_15 = nanmean(AlignedProfile);

load('../../data/S2_exp2/Spikein_normalized_profiles.100-200.S2_exp2_seq1_40min.dm6.mat', 'Occ_147');
Norm_occ = cellfun(@(x,y) x./y, Occ_147, local_norm_factor, 'un', 0);
AlignedProfile = align_sites(Norm_occ, myChr, myLoc, beforeSite, afterSite);
Avg_counts_40 = nanmean(AlignedProfile);

load('../../data/S2_exp2/Spikein_normalized_profiles.100-200.S2_exp2_seq1_60min.dm6.mat', 'Occ_147');
Norm_occ = cellfun(@(x,y) x./y, Occ_147, local_norm_factor, 'un', 0);
AlignedProfile = align_sites(Norm_occ, myChr, myLoc, beforeSite, afterSite);
...
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'Nuc_counts_group_1.S2_exp2.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'Nuc_counts_group_2.S2_exp2.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'Nuc_counts_group_3.S2_exp2.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'Nuc_counts_group_4.S2_exp2.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'Nuc_counts_group_5.S2_exp2.eps'));
...
set(gcf, 'PaperPositionMode', 'auto')
print(gcf, '-depsc', '-painters', fullfile(Figures_folder, 'Nuc_counts_group_6.S2_exp2.eps'));

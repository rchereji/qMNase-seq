...
% Load nuc. counts
load(fullfile(pathName, 'NucCounts.100-200.Kc167_exp1.mat'), 'Chr', 'Loc', 'NucCount', 'noNucs', ...
...
% below we use a norm_factor of 35.
norm_factor = 35;
...
save(fullfile(pathName, 'Fit_results.100-200.NF35.Kc167_exp1.mat'), 'Chr', 'Loc', ...
    'Occ_score', 'Linker_score', 'position_std', ...
    'NucCount', 'O_vector', 'k1_vector', 'k2_vector');

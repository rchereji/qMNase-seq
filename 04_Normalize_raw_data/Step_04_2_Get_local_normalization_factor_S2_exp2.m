load('../../data/S2_exp2/All_Raw_Dyads.100-200.S2_exp2.dm6.mat', 'Dyads')
...
% ans = 0.0366;     
% 3.66% of the genome is marked as bad regions because of extreme coverage 
...
%%
save('../../data/S2_exp2/local_norm_factor.S2_exp2.mat', 'local_norm_factor', 'bad_region_Filter')

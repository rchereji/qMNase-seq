...
save(fullfile(pathName, sprintf('Length_histogram.%s.mat', setName)), 'frag_length', 'frag_count');
...
print(gcf, fullfile(pathName, sprintf('Length_histogram.%s.eps', setName)), '-depsc', '-painters');
